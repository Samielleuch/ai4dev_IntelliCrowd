  ...
  <div>
    <v-form ref="form" v-model="valid">
      <v-row>
        <v-col align="center" cols="12">
          <span class="text-center font-login  ">
            Get funding for your future projects
          </span>
        </v-col>
      </v-row>
      <!-- icon -->
      <v-row justify="center">
        <v-col align="center" cols="12">
          <v-img src="../assets/clients.jpg" max-width="700"></v-img>
        </v-col>
      </v-row>
      ...
      <v-card-text>
        <v-form ref="form" v-model="valid">
          ...
          <v-row class="mb-0 pb-0" justify="center">
            <v-col class="mb-0 pb-0" cols="10">
              <v-text-field
                label="Official Phone/agency Phone"
                :rules="notEmpty"
                class="mb-5 pb-0"
                clearable
                color="black"
    ...
    async validate() {
      ...
      if (this.valid) {
        ...
        try {
          ...
          this.$store.state.currentUser = { type: "org", name: name };
        } catch (e) {
          this.loading = false;
